...
import com.bayzidhimel.emergencyserviceapp.databinding.ActivityKisorgonjHospitalBinding;

public class kisorgonj_hospital extends AppCompatActivity {

    ActivityKisorgonjHospitalBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding=ActivityKisorgonjHospitalBinding.inflate(getLayoutInflater());
